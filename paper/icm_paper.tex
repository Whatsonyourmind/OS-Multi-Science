...
We identify six key limitations:
...
\begin{enumerate}
    ...
    \item \textbf{Invariance component near-constant.} The perturbation invariance $C$ shows low variance across datasets (0.903--0.932), indicating it provides limited discriminative signal in our benchmark. This is because all models in our zoo produce stable predictions under small input perturbations on tabular data. In domains with adversarially sensitive models or high-dimensional inputs (e.g., images, text), we expect $C$ to vary more meaningfully and contribute greater diagnostic value.
